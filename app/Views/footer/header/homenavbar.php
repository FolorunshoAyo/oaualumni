                            ...
                            <div class="col">
                                <nav class="navbar navbar-expand-lg navbar-light white-nav p-0">
                                    <a class="navbar-brand" href="<?php echo base_url(); ?>">
                                        <img class="nav-logo" src="<?php echo base_url('public/assets/club/images/logo/logo.png')?>" alt="">
                                    </a>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        ...
                                        <a href="<?php echo site_url('login')?>" class="text-white hover-text-primary me-3">Login / Register</a>
