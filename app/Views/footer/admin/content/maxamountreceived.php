<div class="content">
    ...
    <div class="page-header">
        <h1 class="title">Maximum Recieved Amount</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('admin')?>">Dashboard</a></li>
            <li class="active">Maximum Received Amount</li>
        </ol>
    ...
    <div class="container-padding">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <form action="<?php echo site_url('admin/maxamountreceived')?>" method="get">
                        <div class="col-md-3">
                            <div class="srlef">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo site_url('admin/maxamountreceived')?>" class="btn btn-primary">Restore Filter</a>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        //dd();
                            ...
                            <table class="table table-hover dataTable">
                                ...
                                <?php foreach($maximumReivedAmount as $maxAmount):?>
                                    <tr>
                                        <td> <b>
                                                <a target="_blank" type="button" href="<?php echo site_url('admin/cashbox?user='.$maxAmount['user_id'].'&fcbd=&tcbd=&ppg=20')?>" data-toggle="tooltip" title="Click to view the Detail">
                                                    <?php echo $maxAmount['cb_amount']?>
                                                </a>
                                            </b></td>
                                        <td><?php echo $maxAmount['cb_date']?></td>
                                        <td><?php echo $maxAmount['cb_type']?></td>
                                        <td>
                                            <?php
                                        ...
                                        ?></td>
                                        <td>
                                            <a class="btn btn-primary" href="<?php echo site_url('admin/userreceivedhistory/'.$maxAmount['user_id'])?>">
