<div class="content">
	...
	<div class="page-header">
		<h1 class="title">All CashBoxes</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo site_url('admin')?>">Dashboard</a></li>
			<li class="active">CashBoxes</li>
		</ol>
	...
	<div class="container-padding">
		...
		<div class="row">
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<form action="<?php echo site_url('admin/cashbox')?>" method="get">
							<div class="col-md-3">
								<div class="srlef">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<a href="<?php echo site_url('admin/cashbox')?>" class="btn btn-primary">Restore Filter</a>
									</div>
								</div>
							</div>
						</form>
								...
								<?php foreach($allUserCashBox as $userCachBox):?>
									<tr>
										...
										<td>
											...
											<a href="javascript:void(0)" class="showProf" data-text="<?php echo base_url('assets/images/prof/' . $userCachBox['cb_prof']); ;?>">
												<img src="<?php echo base_url('assets/images/prof/'.$userCachBox['cb_prof']); ?>" class="img-responsive imgProf">
											</a>
											<?php else: ?>
												N/A
											<?php endif;  ?>
										...
										<td>
                                            <a target="_blank" href="<?php echo site_url('admin/userreceivedhistory/'.$userCachBox['u_id'])?>" class="btn btn-primary">View History</a>
										</td>
