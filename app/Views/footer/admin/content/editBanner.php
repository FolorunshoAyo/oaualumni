            ...
            <div class="row ">
                <div class="col-md-8 m_cont_top">
                    ...
                    <div class="form-group">
                        ...
                        echo form_open_multipart('admin/update-banner',$form);
                        echo form_input('banner_title',$banner[0]['ba_title'],array('class'=>'form-control','placeholder'=>'Please add title'));
                        ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        echo form_input('banner_url',$banner[0]['ba_url'],array('class'=>'form-control','placeholder'=>'Please add URL'));
                        ?>
                    </div>
                    <div class="cf_r">
                    ...
                    <div class="portlet">
                        ...
                        <div id="bg-default" class="panel-collapse collapse in show">
                            <div class="portlet-body">
                                <div class="form-group">
                                    <?php
                                    if (!empty($banner[0]['ba_status']) || $banner[0]['ba_status'] == 0):
                                        $status = array() ;
                                        $status['0'] = 'Disable';
                                        $status['1']= 'Active';
                                        ?>
                                        <label>Status:</label> <span class="red">*</span>
                                        <?php  echo  form_dropdown('status',$status,$banner[0]['ba_status'],array('class'=>'form-control'));
                                        ?>
                                    <?php else: ?>
                        ...
                        <div id="accordion12" class="panel-collapse collapse in show">
                            <div class="portlet-body">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="<?php echo $banner[0]['bn_id'] ?>" name="xeew">
                                    <input type="hidden" value="<?php echo $banner[0]['ba_dp'] ?>" name="dimgo">
                                    <div class="gmiivd">
                                        <?php
                                        $addImage=null;
                                        $ResmoveImage=null;
                                        if (file_exists(realpath(APPPATH . '../assets/images/banners/').'/'.$banner[0]['ba_dp'])) {
                                            $addImage = "dispnn";
                                        ...
                                        <div class="previmg">
                                            <img src="<?php echo base_url('assets/images/banners/'.$banner[0]['ba_dp']); ?>" class="img-fluid">
                                            <br>
