            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <form action="<?php echo site_url('admin/activeloans')?>" method="get">
                                    <div class="col-md-3">
                                        <div class="srlef">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo site_url('admin/activeloans')?>" class="btn btn-primary">Restore Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <?php foreach ($Mywithdraws as $currentWithdraw): ?>
                                    <tr>
                                        ...
                                        <?php if ($currentWithdraw['ul_status'] == 0): ?>
                                            <td>
                                                <a  href="<?php echo site_url('admin/approveloan/'.$currentWithdraw['ul_id'].'/'.$currentWithdraw['withdraw_id']); ?>" class="btn btn-primary">
                                                    Approve Now
                                                </a>
                                            </td>
                                        <?php else: ?>
