...
<!-- Favicon -->
<link rel="shortcut icon" href="<?php echo site_url('public/assets/club/images/favicon.ico')?>">
...
<link rel="stylesheet" type="text/css" href="<?php echo site_url('public/assets/club/css/style.css')?>">