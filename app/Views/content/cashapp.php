...
<head>
    ...
    <script>
        const appId = 'sandbox-sq0idb-I751wEaLBjG6JBXgfLIjQA';
        const locationId = 'LYMWK7X7ZXHX4';
        ...
        async function createPayment(token) {
            ...
            const paymentResponse = await fetch('<?= base_url('cashapp-payment') ?>', {
                method: 'POST',
                headers: {
