        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">Edit message</h4>
        ...
        <div class="row ">
            ...
            <div class="col-md-8 m_cont_top">
                ...
                <div class="form-group">
                    ...
                    echo form_input('name',$message[0]['me_name'],array('class'=>'form-control','placeholder'=>'Please Add name'));
                    ?>
                    <input type="hidden" value="<?php echo $message[0]['me_id'] ?>" name="xeew">
                    <input type="hidden" value="<?php echo $message[0]['me_dp'] ?>" name="dimgo">
                </div>
                <div class="form-group">
                    <span>Message</span><span class="red">*</span>
                    <?php
                    echo form_textarea('message',base64_decode($message[0]['me_message']),
                ...
                <div class="portlet">
                    ...
                    <div id="bg-default" class="panel-collapse collapse in show">
                        <div class="portlet-body">
                            ...
                            <div class="form-group">
                                <?php
                                if (!empty($message[0]['me_status']) || $message[0]['me_status'] == 0):
                                    $status = array() ;
                                    $status['0'] = 'Disable';
                                    $status['1']= 'Active';
                                    ?>
                                    <label>Status:</label> </label><span class="red">*</span>
                                    <?php  echo  form_dropdown('status',$status,$message[0]['me_status'],array('class'=>'form-control'));
                                    ?>
                                <?php else: ?>
                        ...
                        <div class="portlet-body">
                            <div class="form-group">
                                ...
                                <div class="gmiivd">
                                    ...
                                    $addImage=null;
                                    $ResmoveImage=null;
                                    if (file_exists(realpath(APPPATH . '../assets/images/messages/').'/'.$message[0]['me_dp'])) {
                                        $addImage = "dispnn";
                                    ...
                                    <div class="previmg">
                                        <img src="<?php echo base_url('assets/images/messages/'.$message[0]['me_dp']); ?>" class="img-fluid">
                                        <br>
...
/*                echo form_textarea('message',base64_decode($message[0]['me_message']),
            ...
            <div class="col-4">
                   <img src="<?php /*echo base_url('assets/images/messages/'.$message[0]['me_dp']); */?>" class="img-responsive" width="200">
            </div>
        </div>
    </div>
</div>-->
