<div class="content">
    ...
    <div class="page-header">
        <h1 class="title">withdrawal Fund Transfer History/Detail</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('admin')?>">Dashboard</a></li>
            <li class="active">withdrawal Fund Transfer History/Detail</li>
        </ol>
    ...
    <div class="container-padding">
        ...
        <div class="row">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <form action="<?php echo site_url('admin/withftDetail/'.$skzUserId)?>" method="get">
                            <div class="col-md-3">
                                <div class="srlef">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo site_url('admin/withftDetail/'.$skzUserId)?>" class="btn btn-primary">Restore Filter</a>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="col-md-12" id="PrintDiv">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-title">
                        withdrawal Fund Transfer History/Detail
                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach($allUserCashBox as $userCachBox):?>
                                    <tr>
                                        ...
                                        <td># <b><?php echo $userCachBox['uw_id']?></b></td>
                                        <td><?php echo $userCachBox['u_ref_id'] . ' ( '.$userCachBox['user_name'].')'; ?></td>
                                        <td>
                                            <?php
                                            if ($userCachBox['uw_fund_type'] == 'Fund transfer') {
                                                //echo $userCachBox->sender_id;
                                                $userInfoSKZ = getUserInfo($userCachBox['uw_receiver_id']);
                                        ...
                                        <td><?php if(!empty($userCachBox['uw_date'])){ echo $userCachBox['uw_date'];}else{ echo 'N/A';}?></td>
                                        <td><?php echo $userCachBox['uw_date']; ?></td>
                                        <td><?php echo $userCachBox['uw_fund_type']?></td>
                                        <td><?php echo $userCachBox['uw_currency']?></td>
                                        <td>
                                            <?php
                                            //echo $userCachBox->cb_amount;
                                            $cshUTamnt+=$userCachBox['uw_amount'];
                                            echo number_format((float)$userCachBox['uw_amount'], 2, '.', '');
                                            ?>
                                        </td>

                                        <td>
                                            <?php if ($userCachBox['uw_status'] == 1): ?>
