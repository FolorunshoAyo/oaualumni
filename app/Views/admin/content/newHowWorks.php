            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title float-left"> Meet our Executives</h4>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin')?>"> Dashboard </a></li>
                            <li class="breadcrumb-item active">Meet our Executives</li>
                        </ol>
            ...
            <div class="row ">
                <div class="col-md-12 m_cont_top">
                    ...
                    <div class="form-group">
                        ...
                        echo form_open_multipart('admin/add-how-it-works',$form);
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        echo form_input('post','',array('class'=>'form-control','placeholder'=>'Please Add Post'));
                        ?>
                    ...
                    <div class="portlet">
                        ...
                        <div id="bg-defaultsnd" class="panel-collapse collapse in show">
                            <div class="portlet-body">
                                <div class="form-group">
                                    <?php
                                    echo form_input('smfacebook','',array('class'=>'form-control','placeholder'=>'Facebook URL'));
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    echo form_input('smtwitter','',array('class'=>'form-control','placeholder'=>'Twitter URL'));
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    echo form_input('smlinkedin','',array('class'=>'form-control','placeholder'=>'Linkedin URL'));
                                    ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portlet">
                        ...
                        <div id="bg-default" class="panel-collapse collapse in show">
                            <div class="portlet-body">
                                ...
                                <div class="form-group">
                                    <?php echo form_submit('slide','Add Executive','class="btn btn-primary skzmsubmbtn"'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
