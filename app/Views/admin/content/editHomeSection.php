            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title float-left"> Edit What We Do Section</h4>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin')?>"> Dashboard </a></li>
                            <li class="breadcrumb-item active">Edit What We Do Section</li>
                        </ol>
            ...
            <div class="row ">
                <div class="col-md-8 m_cont_top">
                    ...
                    <div class="form-group">
                        ...
                        echo form_open_multipart('admin/update-about-section',$form);
                        echo form_input('title',$homeSection[0]['hs_title'],array('class'=>'form-control','placeholder'=>'Please Add Title'));
                        ?>
                        <input type="hidden" value="<?php echo $homeSection[0]['hs_id'] ?>" name="xeew">
                        <input type="hidden" value="<?php echo $homeSection[0]['hs_dp'] ?>" name="dimgo">
                    </div>
                    <div class="form-group">
                        <span>Description/Content</span><span class="red">*</span>
                        <?php
                        echo form_textarea('text',base64_decode($homeSection[0]['hs_body']),
                    ...
                    <div class="portlet">
                        ...
                        <div id="bg-default" class="panel-collapse collapse in show">
                            <div class="portlet-body">
                                <div class="form-group">
                                    <?php
                                    if (!empty($homeSection[0]['hs_status']) || $homeSection[0]['hs_status'] == 0):
                                        $status = array() ;
                                        $status['0'] = 'Disable';
                                        $status['1']= 'Active';
                                        ?>
                                        <label>Status:</label> </label><span class="red">*</span>
                                        <?php  echo  form_dropdown('status',$status,$homeSection[0]['hs_status'],array('class'=>'form-control'));
                                        ?>
                                    <?php else: ?>
                    ...
                    <div class="portlet">
                        ...
                        <div id="bg-defaultsnd" class="panel-collapse collapse in show">
                            <div class="portlet-body">
                                <div class="form-group">
                                    <?php
                                    echo form_input('buttonText',$homeSection[0]['hs_button_text'],array('class'=>'form-control','placeholder'=>'Button text'));
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    echo form_input('buttonUrl',$homeSection[0]['hs_button_url'],array('class'=>'form-control','placeholder'=>'Button URL'));
                                    ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="accordion12" class="panel-collapse collapse in show">
                            <div class="portlet-body">
                                <div class="form-group">
                                    ...
                                    <div class="previmg">
                                        <img src="<?php echo base_url('public/assets/images/homeSection/'.$homeSection[0]['hs_dp']); ?>" class="img-fluid  img-responsive">
