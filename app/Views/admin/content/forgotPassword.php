                    ...
                    <div class="account-pages">
                        <div class="account-box">
                            <div class="account-logo-box">
                                ...
                                <h5 class="text-uppercase font-bold m-b-5 m-t-50">Forgot Password</h5>
                                <p class="m-b-0">Recover Your Account</p>
                                <?php echo checkFlash();?>
                            </div>
                            <div class="account-content">
                                <form class="form-horizontal" action="<?php echo site_url('admin/recoverAccount')?>" method="post">

                                    <div class="form-group m-b-20 row">
                                        <div class="col-12">
                                            <label for="emailaddress">Email address</label>
                                            <input class="form-control" name="email" type="text" id="emailaddress"  placeholder="john@deo.com">
                                        </div>
                                    </div>
