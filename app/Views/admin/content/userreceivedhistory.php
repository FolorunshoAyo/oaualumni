                        ...
                        <?php if ($history):
                            ...
                            <table class="table table-hover dataTable">
                                ...
                                <?php foreach($history as $receivingHistory):?>
                                    <tr>
                                        <td><?php echo $receivingHistory['cb_amount']?></td>
                                        <td><?php echo $receivingHistory['cb_type']?></td>
                                        <td>
                                            <?php
                                            ...
                                            ?></td>
                                        <td>
                                            <?php if ($receivingHistory['cb_type']=='Fund transfer'): ?>
                                            <a class="btn btn-primary" href="<?php echo site_url('admin/ftDetail/'.$user_id)?>">View Detail</a>
                                            <?php else: ?>
                                                <?php echo 'N/A';?>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <?php foreach($trasactionCount as $tranCount):?>
                                    <tr>
                                        <td>
                                            <p class="font-w-600">
                                            <?php
                                            $userData = getUserData($tranCount['sender_id']);
                                            echo $userData[0]['u_ref_id'] . ' ('.$userData[0]['user_name'].')' ;
                                            ?>
                                            sent <?php echo $tranCount['totalAmount'];?> amount to <?php echo $userAllData[0]['u_ref_id'] . ' ('.$userAllData[0]['user_name'].')'?>  <?php echo $tranCount['TotalTimes']?> times.
                                            </p>
                                        </td>
                                        <td>
                                            <a target="_blank" class="btn btn-primary" href="<?php echo site_url('admin/ftDetail/'.$user_id.'?snd='.$tranCount['sender_id'])?>">
