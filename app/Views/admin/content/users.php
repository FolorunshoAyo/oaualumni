						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<a href="<?php echo site_url('admin/users')?>" class="btn btn-primary">Restore Filter</a>
								</div>
							</div>
						</div>
					</form>
							...
							<table class="table table-hover dataTable">
								...
								<?php foreach($skzUsers as $myuser):?>
									<tr>
										...
										<td><?php echo $myuser['u_last_name']?></td>
										...
										<td>
											<a  href="<?php echo site_url('admin/editUser/'.$myuser['u_id']); ?>" class="btn btn-primary">
												Edit
											</a>
										</td>
