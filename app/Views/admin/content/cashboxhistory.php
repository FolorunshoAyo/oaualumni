	...
	<div class="container-padding">
		...
		<div class="row">
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<form action="<?php echo site_url('admin/cashboxhistory')?>" method="get">
							<div class="col-md-3">
								<div class="srlef">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<a href="<?php echo site_url('admin/cashboxhistory')?>" class="btn btn-primary">Restore Filter</a>
									</div>
								</div>
							</div>
						</form>
			...
			<div class="col-md-12" id="PrintDiv">
				...
				<div class="panel panel-default">
					...
					<div class="panel-title">
						All CashBoxes (<?php echo adminCashBoxAmount(1)?>)
					</div>
								...
								<?php foreach($allUserCashBox as $userCachBox):?>
									<tr>
										...
										<td>
											...
											$cashAmount+=$userCachBox['cb_amount'];
											?>
										</td>
