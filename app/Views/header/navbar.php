                    ...
                    <div class="col-md-8">
                        <div class="d-flex h-100 align-items-center justify-content-start">
                            <div class="me-3"><a href="callto:<?php echo getwebsiteSetting('st_phone');?>" class="text-white">
                                    ...
                                    <?php echo getwebsiteSetting('st_phone');?></a></div>
                            <div class="me-3">
                                <a href="mailto:<?php echo getwebsiteSetting('st_email');?>" class="text-white"><i class="fas fa-envelope text-primary me-1"></i>
